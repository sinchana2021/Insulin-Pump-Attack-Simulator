...
//
//    private final CGMPanel sensor = new CGMPanel(100, 100);
//    private final Panels.RemoteControl rc = new Panels.RemoteControl(40, 230);
//
//    public WorldPanel() {
...
//        InsulinPumpPanel pump = Blackboard.getInstance().getInsulinPump();
//        int px = pump.getX();
//        int py = pump.getY();
//
...
//        Panels.RemoteControl rc = this.rc;
//        int rx = rc.getX();
//        int ry = rc.getY();
//
